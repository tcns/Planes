...
The application contained in this package is released under the above Microsoft Public License (Ms-PL)
Portions of the code use modified versions of the SpriteSheet Sample, available via the XNA Creators Club website.
